document.addEventListener("DOMContentLoaded", () => {
    ...
    // deletar(`dados_agenda_tecnicos/6053640228`)
        ...
        setTimeout(() => {
            ...
            if (!tecnicoValido) {
                ...
                if (estaDuplicado) {
                    ...
                    enviar(`dados_agenda_tecnicos/${novoOmie}/omie`, novoOmie)
                    enviar(`dados_agenda_tecnicos/${novoOmie}/nome`, tecnicoValido.nome)
