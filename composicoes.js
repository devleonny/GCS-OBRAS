        ...
        campos.forEach(campo => {
            ...
            if (chave == 'camposIniciais' || chave == 'complementares') {
                ...
                <td style="background-color: ${campo?.cor || ''};">
                    <input id="${campo?.id || ''}" autocomplete="off" type="number" oninput="calcular('${campo?.id}')" style="text-align: center; width: max-content; background-color: transparent;" value="${campo?.valor || ''}">
                </td>
            `
            }
...
function modelos(produto) {
    ...
    let blocos = {
        'VENDA': {
            camposIniciais: [
                ...
                { label: 'Frete de Compra (2%)', id: 'frete' },
                ...
                { label: 'Aliquota ICMS (Bahia) (20.5%)', id: 'icms_aliquota', valor: 20.5 },
                { label: 'ICMS a ser pago (DIFAL) (%)', id: 'difal', valor: '' },
                { label: 'Valor do ICMS de Entrada (R$)', id: 'icms_entrada' },
                { label: 'Valor de Custo (R$)', id: 'valor_custo', valor: produto?.valor_custo || '' },
                ...
                { label: 'Frete de Venda (5%)', id: 'frete_venda' }
            ],
            presuncoes: [
    ...
    let geral = {
        resultados: [
            ...
            { label: 'PERCENTUAL DE LUCRO', id: 'percentual_lucro' }
        ],
        complementares: [
...
function calcular(campo) {
    ...
    if (modalidade == 'SERVIÇO') {
        ...
        let icmsCreditado = tabelaIcmsSaida[getElementById('icms_creditado_select')]
        ...
        getElementById('frete_venda', frete_venda)
        ...
        let icmsSaida = getElementById('icms_saida_select') / 100
