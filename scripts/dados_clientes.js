...
let dados_clientes_provisorios = {}
...
async function carregar_datalist_clientes() {
    ...
    for (cliente in dados_clientes) {
        ...
        let dados = dados_clientes[cliente]

        items.push(dados.nome)

    }

    let cliente_selecionado = document.getElementById('cliente_selecionado');
    let suggestions = document.getElementById('suggestions');

    cliente_selecionado.addEventListener('input', function () {

        let query = String(cliente_selecionado.value).toUpperCase()
...
function carregar_pagamentos() {
    ...
    let dados_pagamentos = JSON.parse(localStorage.getItem('dados_pagamentos'))
...
function toggleTabela() {
    ...
    let tabela = document.getElementById('tabela_dados_cliente');
...
function recuperar_preenchido() {
    ...
    for (chave in dados_orcam) {
        ...
        let info = dados_orcam[chave]

        if (document.getElementById(chave)) {

            let elemento = document.getElementById(chave)
    ...
    let levantamentos = document.getElementById('levantamentos')
...
async function preencher(campo) {
    ...
    let dados_clientes = {}
    let dados_com_chave_nome = {}
    let termo = document.getElementById(campo).value
    ...
    let lista = ['estado', 'cep', 'bairro', 'cidade']
